            ...
            <div className="mobile-menu-space">
                <div className={`mobile-menu-${showMenu ? 'open' : 'closed'}`}>
                    ...
                    <div className="media-mobile">
                        <a><FontAwesomeIcon className='media-btn' icon={faFacebook} size="2x" style={{color: "#2b75f6"}}/></a>
                        <a><FontAwesomeIcon className='media-btn' icon={faYoutube} size="2x" style={{color: "#fa3333"}}/></a>
                        <a><FontAwesomeIcon className='media-btn' icon={faLaptopCode} size="2x" style={{color: "#90EE90FF"}}/></a>
                    </div>
                </div>
            </div>
        </div>
